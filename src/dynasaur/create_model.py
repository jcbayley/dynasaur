...
def create_models(config, device=None):
    ...
    if config.get("Data","include_previous_positions"):
    ...
    if config.get("Data", "timestep-predict"):
        ...
        feature_shape = config.get("Data", "n_masses") + config.get("Data", "n_masses")*config.get("Data", "n_dimensions")*vel_features*n_basis
