...
def sample_fixed_latent(model, input_data, n_samples, n_data, device="cpu"):
        ...
        for batch, (label, data, batch_times, previous_positions) in enumerate(dataloader):
            ...
            if n_previous_positions > 0:
                ...
                if flow_package == "zuko":
                    ...
                    multi_coeffmass_samples = sample_fixed_latent(model, input_data, n_samples, basis_order, device="cpu")
